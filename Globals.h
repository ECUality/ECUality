...
Parameter low_speed_dwell("lsd", 16, 200);		// the ignition dwell in 4us units. 1ms - 10ms valid range. 
Parameter hi_speed_dwell("hsd", 16, 160);
Parameter starting_dwell("std", 16, 300);			// dwell during starting
